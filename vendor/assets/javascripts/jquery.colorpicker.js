        ...
        colorpicker: function(options) {
            ...
            function create_trigger() {
                trigger.click(function() {
                    var field_id = $(picker).parents('.field').children('.colorpicker').attr('id');
                    var offset = $(this).position();
                    
                    if(field_id == '_background_color'){
                      var top = offset.top - 120;
                      var left = offset.left + $(this).width() - 16;
                    }
                    else {
